...
export function Tweet(
    { tweet, author, replies, likes, retweets, last, media }:
        { tweet: tweet, author: author, media?: media[], replies?: number | null, likes?: number | null, retweets?: number | null, last?: boolean }): JSX.Element {
                    ...
                    <div className="flex-auto w-2/3 lg:w-full text-base md:text-xl">
                        ...
                        {replies &&
                            <div className="flex flex-row justify-center mt-4 -mb-2 gap-8 text-sm font-medium tracking-wider md:flex">
                                <div className="flex text-base group gap-1 items-center" href={`https://twitter.com/intent/tweet?in_reply_to=${tweet.id.toString()}`
                                ...
                                <div className="flex text-base group gap-1 items-center" href={`https://twitter.com/intent/retweet?tweet_id=${tweet.id.toString()}`} target="_blank" rel="noopener noreferrer">
                                ...
                                <div className="flex text-base group gap-1 items-center" href={`https://twitter.com/intent/like?tweet_id=${tweet.id.toString()}`} target="_blank" rel="noopener noreferrer">
