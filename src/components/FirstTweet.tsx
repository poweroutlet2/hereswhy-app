...
export function FirstTweet({ tweet, author, replies, likes, retweets }: { tweet: tweet, author: author, replies: number | null, likes: number | null, retweets: number | null}): JSX.Element {
    if (tweet) {
        return (
            <div className="tweet m-auto mx-10" >
                <div className="bg-white/[10%] backdrop-blur-md backdrop-saturate-150 backdrop-brightness-150 border-b border-white/[10%] rounded-2xl duration-300 my-8 p-5 not-prose max-w-2xl mx-auto tweetcard">
                    <div className='flex justify-between'>
                        <a className='flex items-center gap-3 group' href={`https://twitter.com/${author.username}`}>
